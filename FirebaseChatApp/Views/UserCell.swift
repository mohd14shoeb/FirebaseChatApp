...
/// Description: this class is responsible to customize the view of the cell like the profileImageView and the name so that we can reuse it across different UITableView/UICollectionView
...
class UserCell: UITableViewCell
{
  ...
  /// Description: Every time a Cell is dequeue it this method is called
  ...
  /// Description: to customize the text frame
