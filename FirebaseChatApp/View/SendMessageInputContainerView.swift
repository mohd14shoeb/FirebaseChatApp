...
class SendMessageInputContainerView: UIView, UITextFieldDelegate
{
  var chatController: ChatController?
  {
    didSet
    {
      ...
      uploadImageView.addGestureRecognizer(UITapGestureRecognizer(target: chatController, action: #selector(chatController?.handleImagePicker)))
    }
  }
